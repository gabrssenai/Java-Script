...
function acaoSalvar(){
    ...
    if(itensSalvos !== null){
        ...
        console.log("Objeto do f.salvar: " + typeof(listaCompras));
    }
    listaCompras.push(item);
    localStorage.setItem("listaCompras", JSON.stringify(listaCompras));
    console.log("String do f.salvar: "+ typeof(localStorage.getItem("listaCompras")));
...
function acaoVisualizar(){
    ...
    let itensSalvos = localStorage.getItem("listaCompras");
    //console.log(typeof(itensSalvos));
    if(itensSalvos === null || itensSalvos === ""){
        listaAtual.innerHTML = "<li>Nenhum item salvo</li>";
        return
    }
    listaCompras = JSON.parse(itensSalvos);
    console.log("Objeto do f.limpar: " + typeof(listaCompras));
